  ...
  const runRecovery = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `${data.processedCount} usuarios recuperados de ${data.totalSessions} sesiones analizadas`,
      });
    } catch (error) {
      toast({
        title: "Error inesperado",
        description: "Error al ejecutar recuperación de compras",
        variant: "destructive",
      });
    } finally {
      ...
      <CardContent className="space-y-4">
        <div className="bg-blue-50 p-4 rounded-lg">
          ...
          <ul className="text-sm text-blue-800 space-y-1">
            <li>• Analiza sesiones de checkout completadas en las últimas 24 horas</li>
            <li>• Identifica usuarios que pagaron pero no fueron creados en el sistema</li>
            <li>• Crea automáticamente los usuarios y sus suscripciones</li>
          ...
          <div className="border rounded-lg p-4">
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              ...
              <div className="bg-gray-50 p-3 rounded">
                ...
                <div className="text-xs text-gray-700">Sesiones</div>
              </div>
            </div>
          </div>
        )}
        ...
        >
          {isRecovering ? (
            ...
            <>
              ...
              Ejecutar Recuperación de Compras
            </>
          )}
        </Button>

        <div className="text-sm text-muted-foreground">
          <p>Ejecuta esta función si sospechas que algunas compras no fueron procesadas correctamente.</p>
          <p className="mt-1">⚠️ Esta función solo debe ejecutarse cuando sea necesario.</p>
        </div>
      </CardContent>
    </Card>
  );
