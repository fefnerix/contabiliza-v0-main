...
import { isLikelyPhone, toE164WhatsApp } from '@/utils/phone';
...
const AuthForm: React.FC<AuthFormProps> = ({ 
  ...
  const registerSchema = z.object({
    ...
    if (data.phone) {
      return isLikelyPhone(data.phone);
    }
    return true;
  }, {
  ...
  const handleSubmit = (values: any) => {
    if (isLogin) {
      ...
      // Rastrear evento de lead no Facebook Pixel para formulário de registro
      trackFacebookEvents.lead('registration_form');
