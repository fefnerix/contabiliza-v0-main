...
const WhatsAppActivationButton: React.FC = () => {
  ...
  return (
    <>
      {/* Botão flutuante - posicionado do lado direito */}
      <button 
        onClick={() => setIsOpen(true)} 
        className="fixed bottom-20 right-4 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110 z-50 group" 
        aria-label="Activar cuenta WhatsApp"
      >
          ...
          <div className="text-center space-y-4">
            ...
            <div className="space-y-2">
              <Button 
                ...
                disabled={isLoading}
              >
                {isLoading ? 'Cargando...' : 'Activar mi cuenta'}
              </Button>
