...
const CategoriesPage: React.FC = () => {
      ...
      if ('id' in category) {
        ...
        if (updatedCategory) {
          toast({
            ...
            description: `La categoría ${translateCategoryName(category.name, categoryType, 'es-419')} fue actualizada con éxito.`,
          });
        }
      } else {
        ...
        if (newCategory) {
          toast({
            ...
            description: `La categoría ${translateCategoryName(category.name, categoryType, 'es-419')} fue agregada con éxito.`,
          });
        }
      }
  ...
  return (
    <MainLayout title={t('categories.title')}>
      <SubscriptionGuard feature="categorías personalizadas">
                ...
                {categories.map((category) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <span>{translateCategoryName(category.name, 'expense', 'es-419')}</span>
                    </div>
                    <div>
                      {category.isDefault ? (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <CategoryIcon 
                        ...
                        color={category.color} 
                      />
                      <span>{translateCategoryName(category.name, 'income', 'es-419')}</span>
                    </div>
                    <div>
                      {category.isDefault ? (
                        <Button variant="ghost" size="sm" onClick={() => handleEditCategory(category)}>
