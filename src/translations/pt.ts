export default {
  ...
  subscription: {
    defaultFeature: "esta funcionalidade",
    titleRequired: "Assinatura necessária",
    needActive:
      "Para acessar {feature}, você precisa de uma assinatura ativa do {company}.",
    expired:
      "Sua assinatura expirou. Para continuar acessando {feature}, renove sua assinatura.",
    viewPlans: "Ver planos",
    backToHome: "Voltar ao início",
    planExpiredTitle: "Seu plano expirou",
  ...
  transactions: {
    ...
    edit: {
      ...
      description: 'Altere os dados do registro.',
      success: 'Lançamento atualizado!',
      successDesc: 'As alterações foram salvas.',
  ...
  settings: {
    ...
    currency: 'Moeda',
    country: 'País',
    countryHelp: 'Sua zona horária é atualizada automaticamente',
    theme: 'Tema',
