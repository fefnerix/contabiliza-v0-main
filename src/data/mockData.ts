...
export const mockExpenseCategories: CategorySummary[] = [
      { category: 'Rent', amount: 800, percentage: 40, color: '#16a34a' },
  { category: 'Utilities', amount: 120, percentage: 6, color: '#FF6B6B' },
      { category: 'Groceries', amount: 300, percentage: 15, color: '#16a34a' },
...
export const mockIncomeCategories: CategorySummary[] = [
      { category: 'Salary', amount: 2500, percentage: 86.2, color: '#16a34a' },
