...
INSERT INTO public.poupeja_settings (category, key, value, description) VALUES
  ('branding', 'company_name', 'Contabiliza', 'Nome da empresa exibido na aplicação'),
  ('branding', 'logo_url', '', 'URL da logo da empresa'),
  ('branding', 'favicon_url', '', 'URL do favicon'),
  ('branding', 'logo_alt_text', 'Contabiliza Logo', 'Texto alternativo da logo')
...
INSERT INTO public.poupeja_settings (category, key, value, value_type, description) VALUES
  ('pricing', 'plan_price_monthly', '2', 'number', 'Preço mensal exibido no plano'),
  ('pricing', 'plan_price_annual', '20', 'number', 'Preço anual exibido no plano')
ON CONFLICT (category, key) DO NOTHING;
